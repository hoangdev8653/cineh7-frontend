...
const ShowtimeDeleteModal: React.FC<ShowtimeDeleteModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    return (
        <ModalCustom onClose={onClose} className="w-full max-w-[450px] !bg-white !text-slate-900 border-none rounded-[3rem] p-10 shadow-2xl text-center">
            ...
            <h3 className="text-2xl font-black mb-3 tracking-tight">Xác nhận xóa?</h3>
            <p className="text-slate-400 font-medium text-sm mb-10 leading-relaxed px-4">
                Bạn sắp xóa vĩnh viễn suất chiếu này. Hành động này sẽ ảnh hưởng đến các <span className="text-rose-600">đơn đặt vé hiện có</span> liên quan đến suất chiếu này.
            </p>
...
export default ShowtimeDeleteModal;
