    ...
    const data = {
        ...
        ngayChieuId: {
            ...
            rapId: {
                ...
                hinhAnh: roomDetail?.theater?.image_url || "https://homepage.momocdn.net/placeholder/theater.png",
            }
        },
        suatChieuId: {
            movieId: {
                            ...
                            <div className="flex mb-4 justify-between items-center bg-slate-50 p-4 rounded-xl">
                                <div className="flex items-center">
                                    <img
                                        ...
                                        src={roomDetail?.theater?.image_url || imgageDeafaut}
                                        alt="theater"
                                    />
                                    <div className="ml-4">
                            ...
                            <div className="overflow-x-auto">
                                <div className="w-full flex flex-col items-center">
                                    ...
                                    <div className="ghe w-full mb-8 px-12">
                                        {seats?.map((item: any, index: number) => {
                                            const seatLabel = `${item.row}${item.number}`;
                                            return (
                                                <div key={index} className="flex justify-center p-1">
                                                    <button
                                                        ...
                                                        className={`
                                                            ${arrayGhe.includes(item.id) ? "selected" : ""}
                                                            cursor-pointer status relative transition-transform hover:scale-110
                                                        `}
                                                    >
                                                        <svg
                                                            viewBox="0 0 24 24"
